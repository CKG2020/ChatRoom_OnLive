...
////        date = AFRuleEnginePolicyScore.ReaderjsonAll("C:\\Students\\wangxue\\Desktop\\baogao\\张东.txt");
//        date="xxxxx";
//
...
//     */
    ...
    private static void complexMap2JsonM9() {
        ...
        /**
         *  输出：{1:"No.1",2:"No.2",3:[{"id":2,"name":"Student1"},{"id":3,"name":"Student2"}]}
         */
    }
//
//    /**
...
//        System.out.println(jsonString);
//        /**
//         *  输出：{"id":1,"list":[{"id":2,"name":"Student1"},{"id":3,"name":"Student2"}],"name":"group"}
//         */
//    }
//
    /**
