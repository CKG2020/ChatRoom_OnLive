...
public class ProtoStuffSerializer extends Serializer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] yyys = protoStuffSerializer.serializer("yyy");
        for (int i = 0; i <yyys.length; i++) {
            System.out.println(yyys[i]);
        }
        System.out.println("=============================");
        Object deserializer = protoStuffSerializer.deserializer(yyys, String.class);
